...
public static void main(String[] args) {
    ...
    driver.findElement(By.xpath("(//input[@name='firstName'])[3]")).sendKeys("Amsath");
    driver.findElement(By.xpath("(//input[@name='lastName'])[3]")).sendKeys("Khan");
    driver.findElement(By.xpath("//button[contains(@class,'x-btn-text')and contains(@id,'ext-gen334')]")).click();
    driver.findElement(By.xpath("//a[text()='Amsath']")).click();
